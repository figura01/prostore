...
const ProductForm = ({
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: (product && isUpdate
      ? { ...product }
      : productDefaultValues) as FormValues,
  });
  ...
  console.log("isFeatured: ", form.watch("isFeatured"));
          ...
          <Card>
            <CardContent className="space-y-2 mt-2">
              <FormField
                ...
                name="isFeatured"
                render={({ field }) => (
                  <FormItem className="flex items-center space-y-2 mt-2">
                    <FormControl>
                      <Checkbox
                        checked={field.value}
